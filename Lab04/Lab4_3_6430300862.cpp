...
int main()
{
    ...
    do
    {
        ...
        if (c != ' ' && c != '\n')
        {
            ...
            if (status != 0)
            {
                ...
                {
                    cout << "\""
                         << "Error : " << head->symbol << " Not the corresponding opening symbol."
                         << "\"";
                    break;
                }
            }
    ...
    if (head != NULL)
    {
        ...
        {
            cout << "\""
                 << "Error : " << head->next->symbol << " Not Equal opening and closing symbol."
                 << "\"";
        }
        else if (head->next == NULL && status == 0)
        {
            cout << "Correct" << endl;
        }
    }
